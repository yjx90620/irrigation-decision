...
RULES = [
    ...
    ("algorithm_comparison_*.csv", "rotation_era", "valid_regenerated",
     "audit-v2 physics, 3 seeds - NSGA-III ~ NSGA-II (0.938 vs 0.936), MOEA/D behind", "n/a"),
    ("leave_one_out_rotation_transfer_wq.csv", "rotation_era", "valid_regenerated",
     "per_quota primary-arm transfer (r=0.971 two-factor validation)", "n/a"),
    ("leave_one_out_rotation_summary_wq.csv", "rotation_era", "valid_regenerated",
     "derived from the wq transfer", "n/a"),
    ("ppo_rotation_wq_comparison.csv", "rotation_era", "valid_regenerated",
     "per_quota primary-arm RL comparison (paper-2 primary, 3 seeds x 7 preferences)", "n/a"),
    ("ppo_rotation_*_wq*_final.zip", "rotation_era", "valid_regenerated",
     "per_quota primary-arm models (3 seeds x direct/residual)", "n/a"),
