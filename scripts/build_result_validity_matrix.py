...
RULES = [
    ...
    # --- rotation-era results, invalidated by audit-v2 code fixes ---
    ...
    ("allocation_scan*.csv", "rotation_era", "regenerate_needed",
     "P0-1/P0-2 changed rotation physics", "python src/sim/run_allocation_scan_all_sites.py"),
    ...
    ("task_sensitivity.csv", "rotation_era", "regenerate_needed",
     "P0-1/P0-2 changed rotation physics", "python src/transfer/task_sensitivity.py"),
    ("rotation_policy_comparison.csv", "rotation_era", "regenerate_needed",
     "P0-1/P0-2/P0-3 changed env physics + reward accounting; P1-4 adds preference-eval axis",
     "python src/rl/train_rotation_compare.py --n-seeds 3"),
    ...
    ("ppo_rotation_*.zip", "rotation_era", "regenerate_needed",
     "reward/accounting/env changed (P0-1/P0-2/P0-3); P1-4 adds preference eval",
     "python src/rl/train_rotation_compare.py --n-seeds 3"),
    ("ppo_rotation_*_vecnormalize.pkl", "rotation_era", "regenerate_needed",
     "paired with regenerated models", "python src/rl/train_rotation_compare.py --n-seeds 3"),
    ("ppo_rotation_*_site_transitions.csv", "rotation_era", "regenerate_needed",
     "training diagnostic of the pre-fix runs", "python src/rl/train_rotation_compare.py --n-seeds 3"),
    ...
    # --- raw CMIP6 data ---
    ("data/raw/cmip6/*.csv", "raw_data", "regenerate_needed",
     "P0-7: fail validation (CMCC_CM2_VHR4 shortwave_radiation entirely empty in all files)",
     "python src/data/download_cmip6.py (validates, quarantines, re-downloads)"),
]
